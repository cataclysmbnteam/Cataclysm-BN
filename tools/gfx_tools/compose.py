...
from compose.log import FailFastHandler, log
...
class LogLevel(StrEnum):
    ...
    @classmethod
    def as_level(cls, value: str) -> int:
        return getattr(logging, value)

    def set_level(self):
        log.setLevel(LogLevel.as_level(self))
...
def main(
    ...
    no_tqdm = False
    match feedback:
        case FeedBack.SILENT:
            run_silent = True
        case FeedBack.CONCISE:
            run_silent = False
            no_tqdm = True
        case FeedBack.VERBOSE:
            run_silent = False
            no_tqdm = False
    ...
    return log_tracker.level >= logging.ERROR
