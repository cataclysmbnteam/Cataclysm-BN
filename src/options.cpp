...
void options_manager::cache_balance_options()
{
    ...
    fungal_opt.spread_on_flat_tiles_allowed = ::get_option<bool>( "FUNGUS_SPREAD_ON_FLAT_TILES_ALLOWED" );
    ...
    fungal_opt.advanced_creatures_threshold = ::get_option<int>( "FUNGUS_ADVANCED_CREATURES_THRESHOLD" );
