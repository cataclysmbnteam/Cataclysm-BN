    ...
    const tripoint_abs_omt &origin, int reveal_rad, mission *miss )
{
    ...
    tripoint_abs_omt const surface = overmap_buffer.find_closest( tripoint_abs_omt( origin.xy(), 0 ),
                                     find_params );

    find_params.types.front().first = "hidden_lab_stairs";
    tripoint_abs_omt const underground = overmap_buffer.find_closest( tripoint_abs_omt( origin.xy(),
                                         -1 ),
                                         find_params );
