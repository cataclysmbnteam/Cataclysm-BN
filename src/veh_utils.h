 ...
 */
auto most_repairable_part( vehicle &veh, Character &who_arg,
                                    bool only_repairable = false ) -> vehicle_part &;
/**
 * Repairs a given part on a given vehicle by given character.
 * Awards xp and consumes components.
 */
auto repair_part( vehicle &veh, vehicle_part &pt, Character &who ) -> bool;
} // namespace veh_utils
