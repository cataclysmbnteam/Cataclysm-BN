...
void cata::detail::reg_hooks_examples( sol::state &lua )
{
    ...
    luna::set_fx( lib, "on_char_dodged", []() {} );
    DOC( "Called when a character successfully blocks" );
    luna::set_fx( lib, "on_char_blocked", []() {} );
    DOC( "Called when a character misses an attack" );
    luna::set_fx( lib, "on_char_melee_attack_missed", []() {} );
    DOC( "Called when a character has performed technique" );
    luna::set_fx( lib, "on_char_performed_technique", []() {} );
    DOC( "Called after a character has attempted to attack in melee" );
    luna::set_fx( lib, "on_char_melee_attacked", []() {} );
    DOC( "Called after a character has successfully hit in melee" );
    luna::set_fx( lib, "on_char_melee_attack_hit", []() {} );
    DOC( "Called when character stat gets reset" );
