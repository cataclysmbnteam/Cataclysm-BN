...
input_context game::get_player_input( std::string &action )
{
    ...
    if( do_animations ) {
        ...
        const shared_ptr_fast<game::draw_callback_t> animation_cb =
...
static void cast_spell()
{
    ...
    const std::vector<spell_id> spells = u.magic->spells();
    ...
    const std::set<trait_id> blockers = sp.get_blocker_muts();
    if( !blockers.empty() ) {
