    ...
    public:
        ...
        struct switch_source : value_source {
            ...
            void check( const std::string &context, const mapgen_parameters &params
                ...
                std::vector<std::string> const possible_values = on->all_possible_results( params );
...
class jmapgen_npc : public jmapgen_piece
{
    public:
        ...
        void apply( const mapgendata &dat, const jmapgen_int &x, const jmapgen_int &y
            ...
            string_id<npc_template> const chosen_id = npc_class.get( dat );
    ...
    public:
        ...
        jmapgen_monster( const JsonObject &jsi ) :
            ...
            if( jsi.has_member( "group" ) ) {
                ...
                mapgen_value<mtype_id> const id( jsi.get_member( "monster" ) );
                ids.add( id, 100 );
            }
        }
