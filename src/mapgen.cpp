        ...
        struct param_source : value_source {
            ...
            void check( const std::string &context, const mapgen_parameters &parameters
                ...
                if( param_it == parameters.map.end() ) {
                    ...
                    cata_variant_type const param_type = param.type();
...
class jmapgen_field : public jmapgen_piece
{
    public:
        ...
        void apply( const mapgendata &dat, const jmapgen_int &x, const jmapgen_int &y
            ...
            field_type_id const chosen_id = ftype.get( dat );
...
class jmapgen_npc : public jmapgen_piece
{
    public:
        ...
        void apply( const mapgendata &dat, const jmapgen_int &x, const jmapgen_int &y
            ...
            character_id const npc_id = dat.m.place_npc( point( x.get(), y.get() ), chosen_id );
...
class jmapgen_faction : public jmapgen_piece
{
    public:
        ...
        void apply( const mapgendata &dat, const jmapgen_int &x, const jmapgen_int &y
            ...
            faction_id const chosen_id = id.get( dat );
            if( chosen_id.is_null() ) {
                return;
            }
...
class jmapgen_vending_machine : public jmapgen_piece
{
    public:
        ...
        void apply( const mapgendata &dat, const jmapgen_int &x, const jmapgen_int &y
            ...
            const point r( x.get(), y.get() );
            dat.m.furn_set( r, f_null );
            item_group_id const chosen_id = group_id.get( dat );
            if( chosen_id.is_null() ) {
                return;
            }
...
class jmapgen_gaspump : public jmapgen_piece
{
    public:
        ...
        void apply( const mapgendata &dat, const jmapgen_int &x, const jmapgen_int &y
            ...
            itype_id const chosen_fuel = fuel.get( dat );
    ...
    public:
        ...
        void apply( const mapgendata &dat, const jmapgen_int &x, const jmapgen_int &y
            ...
            if( one_in( chance.get() ) ) {
                itype_id const chosen_id = liquid.get( dat );
                if( chosen_id.is_null() ) {
                    return;
                }
                // Itemgroups apply migrations when being loaded, but we need to migrate
                // individual items here.
                itype_id const migrated = item_controller->migrate_id( chosen_id );
...
class jmapgen_monster_group : public jmapgen_piece
{
    public:
        ...
        void apply( const mapgendata &dat, const jmapgen_int &x, const jmapgen_int &y
            ...
            mongroup_id const chosen_id = id.get( dat );
            if( chosen_id.is_null() ) {
                return;
            }
...
class jmapgen_monster : public jmapgen_piece
{
    public:
        ...
        void apply( const mapgendata &dat, const jmapgen_int &x, const jmapgen_int &y
            ...
            mongroup_id const chosen_group = m_id.get( dat );
            if( !chosen_group.is_null() ) {
                MonsterGroupResult const spawn_details =
                ...
                mtype_id const chosen_type = ids.pick()->get( dat );
...
class jmapgen_vehicle : public jmapgen_piece
{
    public:
        ...
        void apply( const mapgendata &dat, const jmapgen_int &x, const jmapgen_int &y
            ...
            vgroup_id const chosen_id = type.get( dat );
            if( chosen_id.is_null() ) {
                return;
            }
...
class jmapgen_trap : public jmapgen_piece
{
    public:
        ...
        explicit jmapgen_trap( const JsonValue &tid ) {
            if( tid.test_object() ) {
                JsonObject const jo = tid.get_object();
        ...
        void apply( const mapgendata &dat, const jmapgen_int &x, const jmapgen_int &y
            ...
            trap_id const chosen_id = id.get( dat );
            if( chosen_id.id().is_null() ) {
                return;
            }
...
class jmapgen_furniture : public jmapgen_piece
{
    public:
        ...
        void apply( const mapgendata &dat, const jmapgen_int &x, const jmapgen_int &y
            ...
            furn_id const chosen_id = id.get( dat );
            if( chosen_id.id().is_null() ) {
                return;
            }
...
class jmapgen_terrain : public jmapgen_piece
{
    public:
        ...
        void apply( const mapgendata &dat, const jmapgen_int &x, const jmapgen_int &y
            ...
            ter_id const chosen_id = id.get( dat );
            if( chosen_id.id().is_null() ) {
                return;
            }
...
class jmapgen_ter_furn_transform: public jmapgen_piece
{
    public:
        ...
        void apply( const mapgendata &dat, const jmapgen_int &x, const jmapgen_int &y
            ...
            ter_furn_transform_id const chosen_id = id.get( dat );
            if( chosen_id.is_null() ) {
                return;
            }
...
class jmapgen_make_rubble : public jmapgen_piece
{
    public:
        ...
        void apply( const mapgendata &dat, const jmapgen_int &x, const jmapgen_int &y
            ...
            furn_id const chosen_rubble_type = rubble_type.get( dat );
...
class jmapgen_sealed_item : public jmapgen_piece
{
    public:
        ...
        void apply( const mapgendata &dat, const jmapgen_int &x, const jmapgen_int &y
            ...
            furn_id const chosen_furn = furniture.get( dat );
...
class jmapgen_translate : public jmapgen_piece
{
    public:
        ...
        void apply( const mapgendata &dat, const jmapgen_int &/*x*/,
            ...
            ter_id const chosen_from = from.get( dat );
            ter_id const chosen_to = to.get( dat );
...
class jmapgen_zone : public jmapgen_piece
{
    public:
        ...
        void apply( const mapgendata &dat, const jmapgen_int &x, const jmapgen_int &y
            ...
            zone_type_id const chosen_zone_type = zone_type.get( dat );
            faction_id const chosen_faction = faction.get( dat );
        ...
        class neighbor_oter_check
        {
            ...
            public:
                explicit neighbor_oter_check( const JsonObject &jsi ) {
                    for( direction const dir : all_enum_values<direction>() ) {
        ...
        class neighbor_join_check
        {
            ...
            public:
                explicit neighbor_join_check( const JsonObject &jsi ) {
                    for( cube_direction const dir : all_enum_values<cube_direction>() ) {
...
void mapgen_palette::check()
{
    ...
    mapgen_parameters const no_parameters;
        ...
        const std::string &context, bool require_id, bool allow_recur )
{
    ...
    if( jo.has_array( "palettes" ) ) {
        ...
        if( allow_recur ) {
            ...
            add_palette_context const add_context{ context, &new_pal.parameters };
...
void mapgen_function_json::generate( mapgendata &md )
{
    ...
    mapgendata const md_with_params( md, get_args( md, mapgen_parameter_scope::omt ) );
...
void mapgen_function_json_nested::nest( const mapgendata &md, const point &offset ) const
{
    ...
    mapgendata const md_with_params( md, get_args( md, mapgen_parameter_scope::nest ) );
...
void map::draw_mine( mapgendata &dat )
{
    ...
    if( terrain_type == "mine" || terrain_type == "mine_down" ) {
        ...
        for( int i = 0; i < SEEX * 2; i++ ) {
            for( int j = 0; j < SEEY * 2; j++ ) {
                int const i_reverse = ( SEEX * 2 ) - 1 - i;
                int const j_reverse = ( SEEY * 2 ) - 1 - j;
        ...
        if( tries < 20 ) {
            ...
            for( detached_ptr<item> &itm : initial ) {
                ...
                if( cat_rate <= 1.0f ) {
                    ...
                    int const base_count = static_cast<int>( cat_rate );
                    for( int i = 0; i < base_count; i++ ) {
                        if( extra.empty() ) {
                            break;
                        }
                        int const idx = rng( 0, static_cast<int>( extra.size() ) - 1 );
                     ...
                     int faction_id, int mission_id, const std::string &name ) const
{
    ...
    spawn_point const tmp( type, count, offset, faction_id, mission_id, disposition, name );
...
void map::rotate( int turns, const bool setpos_safe )
{
    ...
    if( turns == 2 ) {
        ...
        point const p;
        point const p2 = p.rotate( turns, {2, 2} );
        point const p3 = p2.rotate( turns, {2, 2} );
        point const p4 = p3.rotate( turns, {2, 2} );
    ...
    switch( random_entry( valid_rooms ) ) {
        ...
        case room_lobby:
            if( rotate % 2 == 0 ) { // Vertical
                int const desk = p1.y + rng( ( height / 2 ) - ( height / 4 ),
                                             ( height / 2 ) + 1 );
                ...
                int const desk = p1.x + rng( ( height / 2 ) - ( height / 4 ),
                                             ( height / 2 ) + 1 );
        ...
        case room_split:
            if( rotate % 2 == 0 ) {
                int const w1 = ( ( p1.x + p2.x ) / 2 ) - 2;
                int const w2 = ( ( p1.x + p2.x ) / 2 ) + 2;
                for( int y = p1.y; y <= p2.y; y++ ) {
                ...
                int const w1 = ( ( p1.y + p2.y ) / 2 ) - 2;
                int const w2 = ( ( p1.y + p2.y ) / 2 ) + 2;
                for( int x = p1.x; x <= p2.x; x++ ) {
        ...
        mission *miss, bool verify ) const
{
    ...
    mapgendata const md( omt_pos, update_tmap, 0.0f, calendar::start_of_cataclysm, miss );
        ...
        const bool verify ) const
{
    ...
    rotation_guard const rot( md_with_params );
            ...
            const std::string &update_mapgen_id )
{
    ...
    mapgendata const fake_md( fake_map, mapgendata::dummy_settings );
