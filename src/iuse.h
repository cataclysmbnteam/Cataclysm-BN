...
std::pair<int, units::energy> firecracker_pack( player *, item *, bool, const tripoint & );
std::pair<int, units::energy> firecracker_pack_act( player *, item *, bool, const tripoint & );
std::pair<int, units::energy> firecracker( player *, item *, bool, const tripoint & );
...
std::pair<int, units::energy> tazer2( player *, item *, bool, const tripoint & );
...
std::pair<int, units::energy> fitness_check( player *p, item *it, bool, const tripoint & );
