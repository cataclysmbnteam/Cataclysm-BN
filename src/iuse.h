...
int shockfoil_off( player *, item *, bool, const tripoint & );
int shockfoil_on( player *, item *, bool, const tripoint & );
int shockepee_off( player *, item *, bool, const tripoint & );
int shockepee_on( player *, item *, bool, const tripoint & );
int shocksabre_off( player *, item *, bool, const tripoint & );
int shocksabre_on( player *, item *, bool, const tripoint & );
int shockrapier_off( player *, item *, bool, const tripoint & );
int shockrapier_on( player *, item *, bool, const tripoint & );
int shockstaff_off( player *, item *, bool, const tripoint & );
int shockstaff_on( player *, item *, bool, const tripoint & );
