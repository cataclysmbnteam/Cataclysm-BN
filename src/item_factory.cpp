...
void Item_factory::init()
{
    ...
    add_iuse( "SHOCKFOIL_OFF", &iuse::shockfoil_off);
    add_iuse( "SHOCKFOIL_ON", &iuse::shockfoil_on);
    add_iuse( "SHOCKEPEE_OFF", &iuse::shockepee_off);
    add_iuse( "SHOCKEPEE_ON", &iuse::shockepee_on);
    add_iuse( "SHOCKSABRE_OFF", &iuse::shocksabre_off);
    add_iuse( "SHOCKSABRE_ON", &iuse::shocksabre_on);
    add_iuse( "SHOCKRAPIER_OFF", &iuse::shockrapier_off);
    add_iuse( "SHOCKRAPIER_ON", &iuse::shockrapier_on);
    add_iuse( "SHOCKSTAFF_OFF", &iuse::shockstaff_off);
    add_iuse( "SHOCKSTAFF_ON", &iuse::shockstaff_on);
