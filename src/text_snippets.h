...
class snippet_library
{
    public:
        ...
        auto has_category( const std::string &category ) const -> bool;
        /**
         ...
         */
        auto get_snippet_by_id( const snippet_id &id ) const -> cata::optional<translation>;
        /**
         * Returns a reference to the snippet with the id, or a reference to an
         * empty translation object if no such snippet exist.
         */
        auto get_snippet_ref_by_id( const snippet_id &id ) const -> const translation &;
        /**
         * Returns true if there exists a snippet with the id
         */
        auto has_snippet_with_id( const snippet_id &id ) const -> bool;
        /**
         ...
         * in the JSON files.
         */
        auto expand( const std::string &str ) const -> std::string;
        /**
         ...
         */
        auto random_id_from_category( const std::string &cat ) const -> snippet_id;
        /**
         ...
         * call `expand()` to do that.
         */
        auto random_from_category( const std::string &cat ) const -> cata::optional<translation>;
        /**
         ...
         */
        auto random_from_category( const std::string &cat, unsigned int seed ) const -> cata::optional<translation>;
        /**
         ...
         */
        auto migrate_hash_to_id( int hash ) -> snippet_id;
