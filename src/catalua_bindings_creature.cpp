...
#define UT_CLASS Creature
    {
        ...
        // They're not fool-proof, by the way.
        // **I suggest using the ones for npc, since I actively documented those.**
...
#define UT_CLASS Character
    {
        ...
        //SET_FX_N_T( set_fac_id, "set_faction_id", void( const std::string & ) );
        ...
        //SET_FX_N_T( overmap_sight_range, int( int ) const );
        ...
        // Leaving this out as there's already a query function
        ...
        //SET_FX_N_T(( bodypart_exposure<bodypart_id, float> ), "bodypart_exposure",
