...
void ui_adaptor::redraw_invalidated()
{
    ...
    const restore_on_out_of_scope<bool> prev_redraw_in_progress( redraw_in_progress );
    const restore_on_out_of_scope<bool> prev_restart_redrawing( restart_redrawing );
