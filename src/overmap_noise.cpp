...
auto om_noise_layer_forest::noise_at( const point_om_omt &local_omt_pos ) const -> float
{
...
auto om_noise_layer_floodplain::noise_at( const point_om_omt &local_omt_pos ) const -> float
{
    const point_abs_omt p = global_omt_pos( local_omt_pos );
...
auto om_noise_layer_lake::noise_at( const point_om_omt &local_omt_pos ) const -> float
{
    const point_abs_omt p = global_omt_pos( local_omt_pos );
