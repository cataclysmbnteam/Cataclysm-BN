...
if [ -n "${MXE_TARGET}" ]; then
  ...
  if grep -q "x86_64" <<< "$MXE_TARGET"; then
    curl -L -o libbacktrace-x86_64-w64-mingw32-sha256 https://github.com/Qrox/libbacktrace/releases/download/2020-01-03/libbacktrace-x86_64-w64-mingw32.tar.gz
