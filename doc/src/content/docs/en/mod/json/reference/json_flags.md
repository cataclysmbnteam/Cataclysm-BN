...
- `SEAT_REQUIRES_BALANCE` The player may fall off once they run into something determined by a strength roll.
  TRAIT_DEFT and TRAIT_PROF_SKATER makes it harder to be thrown from vehicle.
- `SECURITY`
