...
```json
{
  ...
  "duration": 180, // amount of time the morale will last (in seconds).
  "decay_start": 60, // amount of time before the effect starts counting down the duration (in seconds).
...
```json
{
  "name": "effect",
  "intensity": 3, // this effect will be applied every X turns.
  "duration": 30, // amount of time the effect will last (in seconds).
  "effect_id_str": "emp",
