...
Variable of type
`<cppval: St3mapI9string_idI23mutation_category_traitEiSt4lessIS2_ESaISt4pairIKS2_iEEE >`
...
Function
`( Character ) -> <cppval: St3mapI6int_idI14body_part_typeEfSt4lessIS2_ESaISt4pairIKS2_fEEE >`
...
Function
`( Creature ) -> <cppval: St6vectorINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESaIS5_EE >`
...
Function `( string, string, int )` Function `( string, string, int, UnitsAngle, double, double )`
