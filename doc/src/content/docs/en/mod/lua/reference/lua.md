...
#### follower_ids
  Variable of type `<cppval: St3setI12character_idSt4lessIS0_ESaIS0_EE >`

#### mutation_category_level
  Variable of type `<cppval: St3mapI9string_idI23mutation_category_traitEiSt4lessIS2_ESaISt4pairIKS2_iEEE >`
...
#### global_omt_location
  Function `( Character ) -> <cppval: N6coords11coord_pointI8tripointLNS_6originE1ELNS_5scaleE2EEE >`
...
#### mutate_towards
  Function `( Character, <cppval: St6vectorI9string_idI15mutation_branchESaIS2_EE >, int ) -> bool`
...
#### get_bionics
  Function `( Character ) -> <cppval: St6vectorI9string_idI11bionic_dataESaIS2_EE >`
...
#### get_power_level
  Function `( Character ) -> UnitsEnergy`
...
#### weight_carried
  Function `( Character ) -> UnitsMass`

#### volume_carried
  Function `( Character ) -> UnitsVolume`

#### volume_capacity
  Function `( Character ) -> UnitsVolume`

#### can_pick_volume
  Function `( Character, UnitsVolume ) -> bool`

#### can_pick_weight
  Function `( Character, UnitsMass, bool ) -> bool`
...
#### get_base_traits
  Function `( Character ) -> <cppval: St6vectorI9string_idI15mutation_branchESaIS2_EE >`

#### get_mutations
  Function `( Character, bool ) -> <cppval: St6vectorI9string_idI15mutation_branchESaIS2_EE >`
...
#### all_items_with_flag
  Function `( Character, JsonFlagId ) -> <cppval: St6vectorIP4itemSaIS1_EE >`
...
#### get_hostile_creatures
  Function `( Character, int ) -> <cppval: St6vectorIP8CreatureSaIS1_EE >`
...
#### drench
  Function `( Character, int, <cppval: 13body_part_set >, bool )`
...
#### bodypart_exposure
  Function `( Character ) -> <cppval: St3mapI6int_idI14body_part_typeEfSt4lessIS2_ESaISt4pairIKS2_fEEE >`
...
#### get_grammatical_genders
  Function `( Creature ) -> <cppval: St6vectorINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESaIS5_EE >`
...
#### in_species
  Function `( Creature, <cppval: 9string_idI12species_typeE > ) -> bool`
...
#### get_size
  Function `( Creature ) -> <cppval: 6m_size >`
...
#### has_flag
  Function `( Creature, <cppval: 6m_flag > ) -> bool`
...
#### name
  Function `( Monster, <cppval: j > ) -> string`
...
#### attitude
  Function `( Monster, Character ) -> <cppval: 16monster_attitude >`
...
#### needs
  Variable of type `<cppval: St6vectorI8npc_needSaIS0_EE >`
...
#### complain_about
  Function `( Npc, string, TimeDuration, string, <cppval: St8optionalIbE > ) -> bool`
...
## SkillLevelMap
### Bases
- `<cppval: St3mapI9string_idI5SkillE10SkillLevelSt4lessIS2_ESaISt4pairIKS2_S3_EEE >`
...
### Members
#### from_radians
  Function `( double ) -> UnitsAngle`

#### to_radians
  Function `( UnitsAngle ) -> double`
...
#### __eq
  Function `( UnitsAngle, UnitsAngle ) -> bool`
...
### Members
#### from_joule
  Function `( int ) -> UnitsEnergy`

#### to_joule
  Function `( UnitsEnergy ) -> int`
...
#### __eq
  Function `( UnitsEnergy, UnitsEnergy ) -> bool`
...
### Members
#### from_milligram
  Function `( <cppval: l > ) -> UnitsMass`

#### to_milligram
  Function `( UnitsMass ) -> <cppval: l >`
...
#### __eq
  Function `( UnitsMass, UnitsMass ) -> bool`
...
### Members
#### from_milliliter
  Function `( int ) -> UnitsVolume`

#### from_liter
  Function `( int ) -> UnitsVolume`

#### to_milliliter
  Function `( UnitsVolume ) -> int`

#### to_liter
  Function `( UnitsVolume ) -> double`

#### __eq
  Function `( UnitsVolume, UnitsVolume ) -> bool`
...
#### get_creature_at
  Function `( Tripoint, <cppval: St8optionalIbE > ) -> Creature`

#### get_monster_at
  Function `( Tripoint, <cppval: St8optionalIbE > ) -> Monster`

#### get_character_at
  Function `( Tripoint, <cppval: St8optionalIbE > ) -> Character`

#### get_npc_at
  Function `( Tripoint, <cppval: St8optionalIbE > ) -> Npc`

#### choose_adjacent
  Function `( string, <cppval: St8optionalIbE > ) -> <cppval: St8optionalI8tripointE >`

#### choose_direction
  Function `( string, <cppval: St8optionalIbE > ) -> <cppval: St8optionalI8tripointE >`

#### look_around
  Function `() -> <cppval: St8optionalI8tripointE >`

#### play_variant_sound
  Function `( string, string, int )`
  Function `( string, string, int, UnitsAngle, double, double )`

#### play_ambient_variant_sound
  Function `( string, string, int, <cppval: N3sfx7channelE >, int, double, int )`
