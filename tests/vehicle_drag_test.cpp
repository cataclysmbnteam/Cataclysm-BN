...
TEST_CASE( "vehicle_drag", "[vehicle] [engine]" )
{
    ...
    test_vehicle_drag( "autotractor", 1.165945, 1.377, 1356.25, 7718, 8005 );
    ...
    test_vehicle_drag( "flatbed_truck", 0.883328, 4.5589, 2041, 9376, 11371 );
    test_vehicle_drag( "pickup", 0.589208, 3.2315, 1307.14, 11194, 13450 );
    test_vehicle_drag( "semi_truck", 0.781317, 10.083741, 5826.445833, 11718, 13797 );
    test_vehicle_drag( "truck_trailer", 1.176534, 13, 5712.5, 0, 0 );
    test_vehicle_drag( "tatra_truck", 0.440213, 7.825,  4182, 17575, 20635 );
    ...
    test_vehicle_drag( "cube_van", 0.518580, 2.71, 2224, 11657, 14011 );
    test_vehicle_drag( "cube_van_cheap", 0.512775, 3.38, 2435, 9853, 11885 );
    ...
    test_vehicle_drag( "DUKW", 0.776903, 3.855, 83.38, 9993, 12063 );
