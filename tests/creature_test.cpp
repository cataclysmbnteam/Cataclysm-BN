...
TEST_CASE( "Check distribution of attacks to body parts for same sized opponents." )
{
    ...
    calculate_bodypart_distribution( creature_size::small, creature_size::small, 0, expected_same.base );
    calculate_bodypart_distribution( creature_size::small, creature_size::small, 1, expected_same.base );
    calculate_bodypart_distribution( creature_size::small, creature_size::small, 100, expected_same.max );
}
...
TEST_CASE( "Check distribution of attacks to body parts for smaller attacker." )
{
    ...
    calculate_bodypart_distribution( creature_size::small, creature_size::medium, 0, expected_smaller.base );
    calculate_bodypart_distribution( creature_size::small, creature_size::medium, 1, expected_smaller.base );
    calculate_bodypart_distribution( creature_size::small, creature_size::medium, 100, expected_smaller.max );
}
...
TEST_CASE( "Check distribution of attacks to body parts for larger attacker." )
{
    ...
    calculate_bodypart_distribution( creature_size::medium, creature_size::small, 0, expected_larger.base );
    calculate_bodypart_distribution( creature_size::medium, creature_size::small, 1, expected_larger.base );
    calculate_bodypart_distribution( creature_size::medium, creature_size::small, 100, expected_larger.max );
}
