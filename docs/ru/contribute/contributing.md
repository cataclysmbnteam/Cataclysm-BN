...
С помощью этих команд вы сможете воссоздать надлежащие условия для тестирования ваших изменений. [Вики DDA](http://cddawiki.chezzo.com/cdda_wiki/index.php) может содержать полезную информацию о меню отладки.
