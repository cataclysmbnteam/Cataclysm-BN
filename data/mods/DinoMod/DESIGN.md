...
* Items folder - BN port removes pocket_data and amm0_to_fire lines and changes damage_type bullet to stab and removes armor entry. No copy-from or event entries in item groups in BN
